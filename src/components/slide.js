      ...
      {(index !== -1) && (
        ...
        >
          <div className="slideContainer" key={slide[ index ].mal_id}>
            <a href={`https://animixplay.to/anime/${slide[index].mal_id}/${slide[index].title}`} target="_blank"><div className="slideImg">
              <img
            ...
            <div className="slideInfo">
              <a href={`https://animixplay.to/anime/${slide[index].mal_id}/${slide[index].title}`} target="_blank"><p className="slideTitle">{slide[ index ].title}</p></a>
              ...
              <div>
                <div className="slideButtons">
                  <i onClick={() => switchSlide('left')} className="fa-solid fa-chevron-left"></i>
                  <i onClick={() => switchSlide('right')} className="fa-solid fa-chevron-right"></i>
                </div>
              </div>
            </div>
          </div>
