      ...
      <div className='searchResults'>
            {results.map(anime =>(
                    <div className='searchItem' key={anime.mal_id}>
                      <a href={`https://animixplay.to/anime/${anime.mal_id}/${anime.title}`} target="_blank"><div className='searchImg'>
                        <img src={anime.image_url} alt={anime.title}></img>
                      </div></a>
                      <div className='searchInfo'>
                        <a href={`https://animixplay.to/anime/${anime.mal_id}/${anime.title}`} target="_blank"><h3 className='searchTitle'>{anime.title}</h3></a>
